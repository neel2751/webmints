    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background sm:px-0 px-2">
      <div className="max-w-7xl mx-auto flex h-16 items-center">
            ...
            {NAV_ITEMS.map((item, index) => (
              <NavigationMenuItem key={index}>
                <NavigationMenuLink asChild className="px-3 py-2 ">
                  <Link href={item.link}>
                    <span
                      className={`font-grotesk text-lg tracking-tight
                        hover:text-indigo-600 transition-colors duration-300 px-1
                        ${
                          paraam === item?.link
        ...
        <div className="hidden md:flex items-center space-x-4 ml-auto">
          <Link
            className="
            bg-indigo-600 hover:bg-indigo-700 text-white font-grotesk font-medium text-base px-4 py-2 rounded-md transition-colors duration-300
            "
            href={"/schedule-call"}
          >
            Schedule a Call
          ...
          <Link
            className="
            text-indigo-600 hover:text-white font-grotesk font-medium text-base px-4 py-2 rounded-md transition-colors duration-300 border border-indigo-600 shadow-sm hover:bg-indigo-600
            "
            href="https://portal.webmints.in"
            target="_blank"
          >
            Login
          </Link>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              ...
              <nav className="flex flex-col space-y-4">
                ...
                <Link
                  href="/schedule-call"
                  className="px-3 py-2 text-center hover:bg-indigo-600 text-white rounded-md bg-indigo-600"
                >
                  Schedule a Call
                </Link>
                <Link
                  href="https://portal.webmints.in"
                  target="_blank"
                  className="px-3 py-2 text-center hover:bg-indigo-600 text-indigo-600 border border-indigo-600 rounded-md hover:text-white transition-colors duration-300"
                >
                  Sign In
                </Link>
              </nav>
