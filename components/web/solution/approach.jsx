    ...
    <div className="bg-gray-900">
      <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          ...
          <div>
            <div className="mb-4">
              <h3 className="text-amber-500 text-xs font-medium uppercase">
                Steps
              </h3>
            </div>
            <div className="flex gap-x-5 ms-1">
              <div className="relative last:after:hidden after:absolute after:top-8 after:bottom-0 after:start-4 after:w-px after:-translate-x-[0.5px] after:bg-neutral-800">
                <div className="relative z-10 size-8 flex justify-center items-center">
                  <span className="flex shrink-0 justify-center items-center size-8 border border-neutral-800 text-amber-500 font-semibold text-xs uppercase rounded-full">
                    1
                  </span>
                </div>
              </div>
            ...
            <a
              className="group inline-flex items-center gap-x-2 py-2 px-3 bg-amber-500 font-medium text-sm text-black rounded-full focus:outline-hidden"
              href="#"
            >
              <svg
