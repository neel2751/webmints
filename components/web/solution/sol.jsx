  ...
  return (
    <section className="py-32">
      <div className="container mx-auto">
        <div className="relative isolate overflow-hidden bg-gradient-to-b from-primary/10 to-transparent md:border-x md:border-border">
          ...
          <div>
            ...
            <div className="relative grid max-w-2xl gap-4 border-x border-border pb-32 sm:grid-cols-2 sm:gap-10 sm:pb-44 md:ml-10 md:border-0">
              ...
              <div className="flex flex-col gap-2">
                <span className="flex gap-5 text-3xl font-semibold text-indigo-600">
