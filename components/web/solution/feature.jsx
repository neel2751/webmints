...
export default function FeatureSol() {
  return (
      ...
      <div className="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
          ...
          >
            ...
            <p className="mt-auto">
              <span className="font-medium text-sm text-amber-500 pb-1 border-b-2 border-neutral-700 group-hover:border-amber-500 group-focus:border-amber-500 transition focus:outline-hidden">
                Case study
              </span>
            </p>
          </a>
            ...
            <div className="mb-5">
              ...
              <div className="mt-5">
                ...
                <p className="mt-1 text-neutral-400">
                  ...
                  GitLab's comprehensive suite of tools and Preline's expertise
