  ...
  return (
    <section className="py-20 lg:py-16 max-w-7xl mx-auto">
      <div className="container mx-auto max-w-7xl">
        <h2 className="container text-center text-2xl font-semibold tracking-tight text-balance sm:text-3xl md:text-4xl lg:text-5xl lg:max-w-4xl mx-auto font-grotesk">
        ...
        <p className="container text-center text-sm mt-2 tracking-tight text-balance sm:text-sm md:text-base lg:text-xl lg:max-w-3xl mx-auto text-black/80 font-sans">
          ...
          <div className="relative container flex max-md:flex-col sm:px-0 px-4">
            <div className="relative flex flex-col justify-between px-0 py-6 md:px-6 md:py-8 flex-1 [&amp;>.title-container]:mb-5 md:[&amp;>.title-container]:mb-8 xl:[&amp;>.image-container]:translate-x-6 [&amp;>.image-container]:translate-x-2">
              <div className="title-container text-balance space-y-2">
                ...
                <p className="text-gray-900 text-lg tracking-tight font-sans">
