    ...
    <section className="border-muted2 border-b bg-[url(https://librar.shadcnblocks.com/images/block/patterns/grid-1.svg)] bg-[length:100%_100%] bg-center bg-no-repeat font-grotesk">
      <div className="container pt-12 md:pt-24 mx-auto">
        <div className="flex flex-col items-center gap-5">
          {/* <ShinyText
            text="Industry-specific SaaS solutions"
          ...
          /> */}
          <h1 className="max-w-[25rem] bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-700 bg-clip-text py-2 sm:px-0 text-center text-3xl leading-tight font-semibold tracking-tight text-transparent md:max-w-[43.75rem] md:text-6xl lg:max-w-[56.25rem] lg:text-[4rem]">
          ...
          <p className="max-w-[25rem] md:max-w-[43.75rem] text-center text-base lg:text-xl text-neutral-800 font-normal font-sans sm:px-0 px-3">
