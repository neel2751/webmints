...
const Test = () => {
  return (
    <section>
      <div className="relative px-8 pt-24 mx-auto md:px-12 lg:px-24 max-w-7xl">
        ...
        <div className="gap-x-2 gap-y-14 mt-12 lg:gap-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            <div>
              ...
              <p className="text-base leading-normal mt-4 text-base-500 font-medium">
                Our cutting-edge design offers a fresh, modern look that
                transforms your project into a standout experience.
              </p>
            </div>
            <ul
              role="list"
          ...
          <div>
            <div>
              ...
              <p className="text-base leading-normal mt-4 text-base-500 font-medium">
                Equipped with advanced features and tools, our solution
                effortlessly manages complex tasks and workflows.
              </p>
            </div>
            <ul
              role="list"
        ...
        <div className="w-full mt-12 -mb-12">
          <Image
            ...
            alt="#_"
            className="w-full shadow rounded-t-2xl"
            width={500}
            height={500}
          />
        </div>
