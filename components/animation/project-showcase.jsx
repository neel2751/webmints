...
const projects = [
  {
    ...
    description: "Identify key opportunities and define project scope.",
    year: "001",
    link: "#",
    image:
  ...
  },
  {
    ...
    description: "Ensuring quality and smooth launch processes.",
    year: "004",
    link: "#",
    image:
  ...
  },
  {
    ...
    description: "Continuous improvement and scaling solutions.",
    year: "005",
    link: "#",
    image:
      "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D$0",
  },
];
            ...
            <div className="relative py-5 border-t border-border transition-all duration-300 ease-out">
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0 ">
                  ...
                  <p
                    className={`
                     text-gray-700 text-base leading-relaxed mt-1
                      transition-all duration-300 ease-out
                      ${
                        hoveredIndex === index
                          ? "text-foreground/70"
