            ...
            <div key={item.id}>
              ...
              >
                <div className="flex items-center gap-6 py-5 px-1">
                  ...
                  {/* Title */}
                  <motion.h3
                    className="text-2xl font-semibold tracking-tight text-black/85"
                    animate={{
              ...
              <AnimatePresence mode="wait">
                {isActive && (
                  ...
                  >
                    <motion.p
                      className="pl-16 pr-12 py-3  text-black/65 text-lg tracking-tight font-medium leading-relaxed"
                      initial={{ y: -10 }}
                      animate={{ y: 0 }}
                      exit={{ y: -10 }}
                      transition={{
