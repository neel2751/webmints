      ...
      <section className="container mx-auto py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center mb-12">
          ...
          <p className="max-w-[42rem] leading-normal text-black sm:text-xl font-sans tracking-tight">
            ...
            So we're saving you the hassle of tens or hundres of thousands of
            doller and doing it all fast, but don't worry, we're not
            overcharging you.
          </p>
        </div>
          ...
          {investmentRanges.map((range, index) => (
            ...
            >
              ...
              <CardFooter>
                ...
                >
                  <Link href={`/request-quote?pricing=${range.slug}`}>
