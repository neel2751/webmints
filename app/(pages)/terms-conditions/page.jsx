...
export const metadata = {
  ...
  description:
    "The terms and conditions governing your access to and use of the WebMints website and services.",
  alternates: {
      ...
      <main id="content">
        ...
        <div className="lg:max-w-5xl px-4 sm:px-6 lg:px-8 pb-12 md:pt-6 sm:pb-20 mx-auto space-y-8">
          <div className="grid gap-4 md:gap-8">
            <div>
              <p className="mb-8  text-xl font-grotesk font-medium tracking-tight">
              ...
              <p className="mb-8 text-neutral-700 font-medium tracking-tight">
              ...
              <p className="mb-8 text-neutral-700 font-medium tracking-tight">
                ...
                use the Site; (3) you will not access the Site through automated
              ...
              <p className="mb-4 dark:text-neutral-400 font-medium tracking-tight">
                ...
                accordance with the Site Privacy Policy.
              </p>
              <p className="mb-3 font-grotesk tracking-tight">
              ...
              <p className="mb-8 dark:text-neutral-400 font-medium tracking-tight">
                ...
                of India. Neel Design Studio and yourself irrevocably consent
              ...
              <p className="mb-8 dark:text-neutral-400 font-medium tracking-tight">
                ...
                jurisdiction of the India courts. Neel Design Studio shall also
                maintain the right to bring proceedings as to the substance of
              ...
              <p className="mb-3 dark:text-neutral-400 font-medium tracking-tight">
