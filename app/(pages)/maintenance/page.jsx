...
export const metadata = {
  title: "SaaS Maintenance & Support Plans for UK Businesses",
  description:
    "Ongoing maintenance and support plans for your custom SaaS platform, covering bug fixes, security patches, and proactive monitoring from the Webmints team.",
  alternates: {
        ...
        <div className="relative overflow-hidden rounded-lg border-2 border-indigo-600 bg-white px-6 py-6 shadow-md">
          ...
          <p className="mt-4 text-sm text-muted-foreground font-sans">
            ...
            <span className="font-semibold font-grotesk text-indigo-600">
              limited number of new projects each month
            </span>{" "}
                ...
                {maintenancePlans.map((plan, index) => (
                  ...
                  >
                    ...
                    <CardFooter>
                      ...
                      >
                        <Link
                          href={`/contact-sales?maintenance_plan=${plan.slug}&type=monthly`}
                        >
                          {plan.buttonText}
                        </Link>
                      </Button>
                  ...
                  return (
                    ...
                    >
                      ...
                      <CardFooter>
                        ...
                        >
                          <Link
                            href={`/contact-sales?maintenance_plan=${plan.slug}&type=annual`}
                          >
                            {plan.buttonText}
                          </Link>
                        </Button>
...
const maintenancePlans = [
  {
    ...
    href: "/contact-sales?maintenance_plan=basic",
    popular: false,
  },
  {
    ...
    href: "/contact-sales?maintenance_plan=professional",
    popular: true,
  },
  {
    ...
    href: "/contact-sales?maintenance_plan=enterprise",
    popular: false,
  },
];
