  ...
  return (
    <div className="flex flex-col gap-16 pb-16 font-grotesk">
          ...
          <JsonLd
            data={{
              ...
              description: [
                ...
                .filter(Boolean)
                .join(" "),
              employmentType: jobData.type?.toUpperCase().replace(/[\s-]+/g, "_"),
              hiringOrganization: {
                "@type": "Organization",
                name: "WebMints",
                sameAs: SITE_URL,
      ...
      <section className="relative">
        ...
        <div className="container relative py-16 md:py-24 mx-auto">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="text-xl font-medium text-muted-foreground tracking-tight animate-in fade-in slide-in-from-top-4 duration-700 delay-300">
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="md:col-span-2">
              <div className="space-y-10">
                <div>
                  <h2 className="font-bold text-black/75 mb-4 text-5xl tracking-tighter">
                    About the Role
                  </h2>
                  <p className="text-lg font-medium leading-snug text-gray-500 mb-8 tracking-tight">
                    {jobData.aboutRole}
                  </p>
                </div>

                <div>
                  <h2 className="text-2xl font-bold text-gray-800 tracking-tighter mb-4">
                    Responsibilities
                  </h2>
                  <ul className="space-y-2">
                    {jobData.responsibilities.map((responsibility, index) => (
                      <li key={index} className="flex items-start gap-2">
                        ...
                        <h3 className="text-base font-medium mb-2 tracking-tight text-gray-800">
                          {responsibility}
                        </h3>
                      </li>
                    ))}
      ...
      <CareerCta
        ...
        description="Stay updated on new opportunities by subscribing to our job alerts. Be the first to know when we post openings that match your skills and interests."
        buttonText="Subscribe Now"
        supportedText="By subscribing, you agree to receive job alerts and updates from Webmints. You can unsubscribe at any time."
      />
    </div>
  );
}
