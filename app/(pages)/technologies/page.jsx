...
export const metadata = {
  ...
  description:
    "The modern technologies WebMints uses to build robust, scalable, and secure SaaS solutions tailored to your industry needs.",
  alternates: {
            ...
            {industryTechnologies.map((industry, index) => (
              ...
              >
                ...
                <CardFooter>
                  ...
                  >
                    <Link
                      href={`/contact-sales?industry=${industry.id}`}
